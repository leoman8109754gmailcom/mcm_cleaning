/**
 * Commercial Service Schema (Singleton)
 *
 * Manages content for the commercial cleaning service page
 */
...
export default {
  ...
  fields: [
    ...
    },
    {
      ...
      description: 'Text displayed in the homepage services menu (e.g., "COMMERCIAL.")',
