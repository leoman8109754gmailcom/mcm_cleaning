...
function ElectrostaticCleaningPage() {
  ...
  <div className="relative pt-24 md:pt-28 pb-8">
        <h1 className="font-bayon text-3xl md:text-6xl font-bold text-center text-[#2B6B6B] uppercase tracking-wide">
      ...
      <div className="font-bayon bg-[#FFEBD0] relative py-16">
        <div className="max-w-3xl mx-auto px-8 text-center">
          ...
          <p className=" font-bayon text-base md:text-xl text-[#F39237] leading-relaxed">
...
export default ElectrostaticCleaningPage;